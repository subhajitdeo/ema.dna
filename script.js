...
function renderCards() {
  container.innerHTML = "";
  currentData.forEach(stock => container.appendChild(createCard(stock)));
}

function sortData(criterion) {
  if (criterion === "score") currentData.sort((a, b) => b.score - a.score);
  else if (criterion === "change") currentData.sort((a, b) => b.change - a.change);
  else if (criterion === "symbol") currentData.sort((a, b) => a.symbol.localeCompare(b.symbol));
  renderCards();
}
